<template>
    ...
    <div>
        ...
        <div class="grid justify-center absolute max-md:top-[72rem] max-sm:relative max-sm:top-[81rem] max-sm:overflow-x-hidden  max-[1200px]:top-[61rem] min-[1200px]:top-[50rem] left-1/2 transform -translate-x-1/2 -translate-y-1/2">
