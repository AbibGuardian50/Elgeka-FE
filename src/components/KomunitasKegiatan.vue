...
<template>
    ...
    <div>
        ...
        <div>
            ...
            <div class="grid pt-40 grid-cols-2 gap-8 pb-4">
                <div v-for="kegiatan in received_kegiatankomunitas" :key="kegiatan.id" class="flex items-start flex-col ml-8">
                    ...
                    <div>
                        ...
                        <p class="font-poppins font-normal leading-6 text-base py-4 max-w-[620px]">{{ kegiatan.content }}.</p>
                        <router-link to="/detailkegiatan"><button type="button"
                                class="bg-orange text-white py-2 px-16 rounded-full">Selengkapnya</button></router-link>
                    </div>
